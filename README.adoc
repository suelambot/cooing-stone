...
----
$ git clone git@github.com:suelambot/cooing-stone
...
You can interact with the booster using the form at the secured endpoint URL and the link:http://launcher.fabric8.io/docs/thorntail-runtime.html#rhsso-realm-model_secured[provided users].
...
To run the integration test on the Secured HTTP API booster follow the steps in the link:https://launcher.fabric8.io/docs/thorntail-runtime.html#running-the-secured-booster-integration-tests[Secured Booster documentation].
